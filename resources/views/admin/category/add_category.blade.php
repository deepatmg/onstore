            ...
            <div class="media user-media well-small">
                ...
                <div class="media-body">
                    ...
                    <ul class="list-unstyled user-info">
                        ...
                        <li>
                             <a class="btn btn-success btn-xs btn-circle" style="width: 10px;height: 12px;"></a> @if(session()->get('loggedIn')==1) Online @else Offline @endif
...
<div class="container-fluid">
      ...
      <div class="panel-heading">
        <h3 class="panel-title"><i class="icon-pencil"></i> Add Category</h3>
      </div>
      <div class="panel-body">
        <form action="{{url('savecat')}}" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="title" value="" placeholder="Category Name" id="input-name1" class="form-control" />
                                          </div>
                  </div>
