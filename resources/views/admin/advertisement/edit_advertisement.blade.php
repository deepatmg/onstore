...
<head>
     ...
     <meta charset="UTF-8" />
    <title>Admin | Edit Advertisements</title>
...
<div class="container-fluid">
      ...
      <div class="panel-heading">
        <h3 class="panel-title"><i class="icon-pencil"></i> Edit advertisement</h3>
      </div>
      <div class="panel-body">
        <form action="{{url('editadvt')}}/{{$res->id}}" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
        {{csrf_field()}}
          <div class="tab-content">
                  <div class="form-group required" style="height:50px;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="title" value="{{$res->title}}" placeholder="Advertisement Title" id="input-name1" class="form-control" />
                                          </div>
                  </div>
                  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-price">Price</label>
                <div class="col-sm-10">
                  <input type="text" name="price" value="{{$res->price}}" placeholder="Price" id="input-price" class="form-control" />
                </div>
              </div>
               <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="keyword" value="{{$res->SEOurl}}" placeholder="SEO URL" id="input-keyword" class="form-control" />
                                  </div>
              </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="status" id="input-status" class="form-control">
                                        <option value="{{$res->status}}" selected="selected">@if($res->status==1) Enabled @else Disabled @endif</option>
                    <option value="@if($res->status==1) 0 @else 1 @endif">@if($res->status==0) Enabled @else Disabled @endif</option>
                                      </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="sortorder" value="{{$res->sortorder}}" placeholder="Sort Order" id="input-sort-order" class="form-control" />
                </div>
              </div>
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    <tr>
                      <td class="text-left"><a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img src="{{url($res->image)}}" alt="" title="" data-placeholder="{{url($res->image)}}" /></a><input type="file" name="image" value="{{$res->image}}" id="input-image" /></td>
                  </tr>
                  </tbody>
                </table>
              </div>
