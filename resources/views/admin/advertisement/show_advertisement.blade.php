...
<head>
      <meta charset="UTF-8" />
    <title>Admin | Show Advertisement</title>
...
<li class="panel">
    ...
    <div class="container-fluid">
      <div class="pull-right"><a href="{{url('addadvt')}}" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="icon-plus"></i></a>
        <button type="submit" form="form-product" formaction="http://localhost/upload/admin/index.php?route=catalog/product/copy&amp;token=vmLkKMal6xYQ3RKrKNJexgFoESc7uDtX" data-toggle="tooltip" title="Copy" class="btn btn-default"><i class="icon-copy"></i></button>
      ...
      <ul class="breadcrumb">
                ...
                <li><a href="{{url('showadvt')}}">Advertisement</a></li>
              </ul>
    </div>
  </div>
  <div class="container-fluid">
      ...
      <div class="panel-heading">
        <h3 class="panel-title"><i class="icon-list"></i> Ad List</h3>
      </div>
      <div class="panel-body">
       
        <form action="{{url('deleteadvt')}}" method="post" enctype="multipart/form-data" id="form-product">
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left">                    <a href="http://localhost/upload/admin/index.php?route=catalog/product&amp;token=vmLkKMal6xYQ3RKrKNJexgFoESc7uDtX&amp;sort=pd.name&amp;order=DESC" class="asc">Ad Title</a>
                    </td>
                 
                  <td class="text-right">                    <a href="http://localhost/upload/admin/index.php?route=catalog/product&amp;token=vmLkKMal6xYQ3RKrKNJexgFoESc7uDtX&amp;sort=p.price&amp;order=DESC">Price</a>
                    </td>
                  
                  <td class="text-left">                    <a href="http://localhost/upload/admin/index.php?route=catalog/product&amp;token=vmLkKMal6xYQ3RKrKNJexgFoESc7uDtX&amp;sort=p.status&amp;order=DESC">Status</a>
                    </td>
              ...
              <tr>
                  ...
                  <td class="text-right"><a href="{{url('editadvt')}}/{{$row->id}}" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="icon-pencil"></i></a></td>
                </tr>
             @endforeach
                 <tr>
                  <td class="text-center">                    <input type="checkbox" name="selected[]" value="42" />
                    </td>
                  <td class="text-center">                    <img src="http://localhost/upload/image/cache/catalog/demo/apple_cinema_30-40x40.jpg" alt="Apple Cinema 30&quot;" class="img-thumbnail" />
                    </td>
                  <td class="text-left">Apple Cinema 30&quot;</td>
                  
                  <td class="text-right">                    <span style="text-decoration: line-through;">100.0000</span><br/>
                    <div class="text-danger">90.0000</div>
                    </td>
                  <td class="text-left">Enabled</td>
                  <td class="text-right"><a href="#" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="icon-pencil"></i></a></td>
                </tr>
                                <tr>
                  <td class="text-center">                    <input type="checkbox" name="selected[]" value="30" />
                    </td>
                  <td class="text-center">                    <img src="http://localhost/upload/image/cache/catalog/demo/canon_eos_5d_1-40x40.jpg" alt="Canon EOS 5D" class="img-thumbnail" />
                    </td>
