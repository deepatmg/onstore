...
<div class="page-header">
  ...
  <div class="container-fluid">
      ...
      <div class="panel-heading">
        <h3 class="panel-title"><i class="icon-pencil"></i> Add Product</h3>
      </div>
      <div class="panel-body">
        <form action="{{url('saveproduct')}}" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
        <input type="hidden" name="_token" value="{{csrf_token()}}">
          <div class="tab-content">
                ...
                <div class="col-sm-2">
                  <input type="text" name="pcode" value="" placeholder="Code" id="input-model" class="form-control" />
                  {{$errors->first('pcode')}}
                                  </div>
                  ...
                  <div class="form-group" style="height:auto;">
                    ...
                    <div class="col-sm-10">
                      <textarea name="description" placeholder="Description" id="input-description1" class="form-control summernote"></textarea>
                      <script>
                ...
                CKEDITOR.replace( 'input-description1' );
                  ...
                  <div class="form-group required" style="height:50px;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="meta_title" value="" placeholder="Meta Tag Title" id="input-meta-title1" class="form-control" />
              ...
              <div class="form-group" style="height:50px;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="brand" value="" placeholder="Brand" id="input-brand" class="form-control" />
                    </div>
                  </div>
...
function addImage() {
    ...
    html += '  <td class="text-left"><div class="fileupload fileupload-new" data-provides="fileupload"><input type="hidden" value="" name="product_image['+image_row+'][image]"><div style="float: left;" class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="{{url('assets/img/demoUpload.jpg')}}" alt=""></div><div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 10px; float: left;" ></div><div><span class="btn btn-file btn-primary"><span class="fileupload-new">Select image</span><span class="fileupload-exists">Change</span><input type="file" name="product_image['+image_row+'][image]" id="input-image' + image_row + '"></span><a href="#" class="btn btn-danger fileupload-exists" data-dismiss="fileupload">Remove</a></div></div></td>';
